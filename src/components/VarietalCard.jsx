            ...
            <Accordion className="accordion">
                <Accordion.Item eventKey="0">
                    ...
                    <Accordion.Body className='varietal-card'>
                        ...
                        <h4><i className="bi bi-water"></i> Water</h4>
                        <div className="content">{water}</div>
                        <h4><i className="bi bi-cloud-fill"></i> Humidity</h4>
                        <div className="content">{humidity}</div>
                        <h4><i className="bi bi-exclamation-diamond"></i> Toxicity</h4>
                        <div className="content">{toxicity}</div>
                        <h4><i className="bi bi-thermometer-half"></i> Temperature</h4>
